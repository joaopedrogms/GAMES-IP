...
def main():
    ...
    jaula = Key(900, 50, "image-remove.png", 0.2)
    ...
    morangos.add(morango1, morango2, morango3, morango4, morango5, morango6, morango7, morango8, morango9, morango10, morango11)
