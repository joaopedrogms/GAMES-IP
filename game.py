...
class HUD(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        chave_dourada_rect.topleft = (self.image.get_width() - 1000, 10)
        ...
        chave_azul_rect.topleft = (self.image.get_width() - 1000, 50)
        self.image.blit(self.chave_azul_image, chave_azul_rect)
        chave_azul_count = self.key_font.render(str(self.character.chaves_azuis_coletadas), True, (150, 150, 150))
...
def main():
    ...
    jaula = Key(300, 600, "image-remove.png", 0.5)
